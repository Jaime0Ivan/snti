...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text'       => 'Cen y Comisiones',
            'route'        => 'comisione.index',
            'icon'          =>'fas fa-fw fa-file'
        ],
        [
            'text'       => 'Secciones sindicales',
            'route'        => 'seccione.index',
            'icon'          =>'fas fa-fw fa-file'
        ],
        [
            'text'       => 'Informacion ',
